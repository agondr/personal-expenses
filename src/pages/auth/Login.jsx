      ...
      <div className="bg-[#121212] p-8 rounded-xl shadow-lg w-[90%] max-w-md">
        <div className="flex flex-col items-center space-y-4">
          ...
          <input
            ...
            className="w-full px-4 py-3 mt-4 bg-[#1e1e1e] text-white rounded-md border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />

          <input
            type="password"
            placeholder="Password"
            className="w-full px-4 py-3 mt-3 bg-[#1e1e1e] text-white rounded-md border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />

          <button className="w-full mt-5 py-3 bg-gradient-to-r from-blue-600 to-blue-500 rounded-md text-white font-semibold hover:opacity-90 transition">
            Login
          </button>
