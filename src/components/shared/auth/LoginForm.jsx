  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className=" w-96">
        ...
        <Button
          type="submit"
          className="w-full mt-5 p-6 bg-gradient-to-r from-blue-600 to-blue-500 rounded-md text-lg text-white font-semibold hover:opacity-90 transition hover:cursor-pointer"
        >
          Login
        </Button>
      </form>
